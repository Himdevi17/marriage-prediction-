...
set_background("image.jpg")  # Make sure image.jpg is in the same folder
...
def user_input_features():
    ...
    age_category = st.selectbox("Age Category", options=["Middle-aged", "Senior", "Young", "Not available"])
    ...
    data = {
        ...
        'AgeCategory_not available': age_category_not_available
    }
...
st.markdown("""
This tool predicts the likely response to a marriage proposal based on various factors such as height, age, income, and personal compatibility scores.
""")
